...
public class MediaStoreHelper {
    ...
    public static void getPhotoDirs(FragmentActivity activity, Bundle args, PhotosResultCallback resultCallback) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int grantedPermission = ActivityCompat.checkSelfPermission(activity, Manifest.permission.READ_EXTERNAL_STORAGE);
